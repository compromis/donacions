export default {
  ...
  "receipt": {
    ...
    "thanks_paypal": "¡Hemos recibido tu donación, muchas gracias por tu compromiso!",
    "thanks_wire": "Para completar tu donación, solo queda que hagas una transferencia al siguiente número de cuenta. ¡Gracias por tu compromiso!",
    "subject": "Concepto",
  ...
  "errors": {
    ...
    "max": "La qüantitat màxima per a donacions és {amountMax} €",
    "min": "La donació mínima és {amountMin} €",
    "accept": "Has de llegir i acceptar la informació de protecció de dades abans de continuar"
  },
  "paypal": {
